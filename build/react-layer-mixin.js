...
var createElement = function createElement(x) {
  return (0, _platform.isClient)() ? document.createElement(x) : _utils.noop;
};

var bodyAppendElement = function bodyAppendElement(x) {
  return (0, _platform.isClient)() ? document.body.appendChild(x) : _utils.noop;
};

var bodyRemoveElement = function bodyRemoveElement(x) {
  return (0, _platform.isClient)() ? document.body.removeChild(x) : _utils.noop;
};
